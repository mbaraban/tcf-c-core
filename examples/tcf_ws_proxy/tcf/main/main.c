...
static const char * help_text[] = {
    "Usage: tcf_ws_proxy [OPTION]...",
    "Start Target Communication Framework Web Socket proxy.",
    "For instance:",
    "    tcf_ws_proxy -s WS::1437 TCP:128.224.218.33:4576",
    "This starts the TCF WebSocket server on port 1437 on the local machine and "
